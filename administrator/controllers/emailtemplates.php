 ...
 * @since  1.6
 */
class HqcblistmailerControllerEmailtemplates extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_hqcblistmailer&view=emailtemplates');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'emailtemplate', $prefix = 'HqcblistmailerModel', $config = array())
	{
