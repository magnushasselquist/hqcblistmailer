 ...
 * @since  1.6
 */
class HqcblistmailerViewEmailtemplates extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		HqcblistmailerHelpersHqcblistmailer::addSubmenu('emailtemplates');
	...
	protected function addToolbar()
	{
		...
		$canDo = HqcblistmailerHelpersHqcblistmailer::getActions();

		JToolBarHelper::title(JText::_('COM_HQCBLISTMAILER_TITLE_EMAILTEMPLATES'), 'emailtemplates.png');

		// Check if the form exists before showing the add/edit buttons
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/views/emailtemplate';
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				JToolbarHelper::custom('emailtemplates.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
			}

			if ($canDo->get('core.edit') && isset($this->items[0]))
			{
				JToolBarHelper::editList('emailtemplate.edit', 'JTOOLBAR_EDIT');
			}
		}
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
				JToolBarHelper::divider();
				JToolBarHelper::archiveList('emailtemplates.archive', 'JTOOLBAR_ARCHIVE');
			}
		...
		if (isset($this->items[0]->state))
		{
			...
			{
				JToolBarHelper::trash('emailtemplates.trash', 'JTOOLBAR_TRASH');
				JToolBarHelper::divider();
			}
		}
		...
		JHtmlSidebar::setAction('index.php?option=com_hqcblistmailer&view=emailtemplates');
