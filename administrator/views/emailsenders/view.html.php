...
class HqcblistmailerViewEmailsenders extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		HqcblistmailerHelpersHqcblistmailer::addSubmenu('emailsenders');
	...
	protected function addToolbar()
	{
		...
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/views/emailsender';
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				JToolbarHelper::custom('emailsenders.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
			}
